...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("BambaMagicKeep", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("BambaMagicKeep", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "BambaMagicKeep";
		app.meta["name"] = "BambaMagicKeep";
		app.meta["packageName"] = "com.sample.bambamagickeep";
		...
		#elseif air
		app.window.title = "BambaMagicKeep";
		#else
