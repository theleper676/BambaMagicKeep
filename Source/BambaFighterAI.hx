...
class BambaFighterAI extends DisplayObject {
	var enemy:BambaFighter;

	var GOOD_ATTACK_CHANCE:Float = 0.1;
	...
	public function new(param1:BambaFighter) {
	...
	function switchLocations(param1:Dynamic, param2:Dynamic, param3:Dynamic):Void {
	...
	public function returnSequence():Dynamic {
